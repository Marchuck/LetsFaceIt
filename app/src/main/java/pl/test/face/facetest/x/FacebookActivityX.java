 ...
 */
public class FacebookActivityX extends FragmentActivity {
    public static final String TAG = FacebookActivityX.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.facebook.R.layout.com_facebook_activity_layout);
        ...
        if (fragment == null) {
            if (FacebookDialogFragment.TAG.equals(intent.getAction())) {
                Log.i(TAG, "onCreate: facebook dialog fragment");
                ...
                manager.beginTransaction()
                        .add(com.facebook.R.id.com_facebook_fragment_container, fragment, FRAGMENT_TAG)
                        .commit();
            }
        }
