...
final class LegacyTokenHelperX {
    /**
    ...
    public static final String TOKEN_SOURCE_KEY =
            "com.facebook.TokenCachingStrategy.AccessTokenSourceX";
    ...
    private static final String TAG = LegacyTokenHelperX.class.getSimpleName();
    ...
    public LegacyTokenHelperX(Context context) {
        this(context, null);
    }

    public LegacyTokenHelperX(Context context, String cacheKey) {
    ...
    public static  AccessTokenSourceX getSource(Bundle bundle) {
        Validate.notNull(bundle, "bundle");
        if (bundle.containsKey(TOKEN_SOURCE_KEY)) {
            return ( AccessTokenSourceX) bundle.getSerializable(TOKEN_SOURCE_KEY);
        } else {
            boolean isSSO = bundle.getBoolean(IS_SSO_KEY);
            return isSSO ?  AccessTokenSourceX.FACEBOOK_APPLICATION_WEB :  AccessTokenSourceX.WEB_VIEW;
        }
    }

    public static void putSource(Bundle bundle, com.facebook.AccessTokenSource value) {
        Validate.notNull(bundle, "bundle");
