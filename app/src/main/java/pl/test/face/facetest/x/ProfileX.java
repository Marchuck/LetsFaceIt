 ...
 */
public final class ProfileX implements Parcelable {
     ...
     */
    public static ProfileX getCurrentProfile()
    {
        return ProfileManagerX.getInstance().getCurrentProfile();
    }
     ...
     */
    public static void setCurrentProfile(ProfileX profile) {
        ProfileManagerX.getInstance().setCurrentProfile(profile);
    }
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (accessToken == null) {
            ProfileX.setCurrentProfile(null);
            return;
        }
        ...
        Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(),
                new Utility.GraphMeRequestWithCacheCallback() {
                    ...
                    public void onSuccess(JSONObject userInfo) {
                        ...
                        ProfileX.setCurrentProfile(profile);
                    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ProfileX)) {
            return false;
        }

        ProfileX o = (ProfileX) other;
    ...
    public ProfileX(JSONObject jsonObject) {
    ...
    public static final Parcelable.Creator<ProfileX> CREATOR = new Parcelable.Creator() {

        @Override
        public ProfileX createFromParcel(Parcel source) {
            return new ProfileX(source);
        }

        @Override
        public ProfileX[] newArray(int size) {
            return new ProfileX[size];
        }
    };
}
