 ...
 * round-trip.
 */
public class GraphRequestBatchX extends AbstractList<GraphRequestX> {
    private static AtomicInteger idGenerator = new AtomicInteger();

    private Handler callbackHandler;
    private List<GraphRequestX> requests = new ArrayList<GraphRequestX >();
     ...
     */
    public GraphRequestBatchX(Collection<GraphRequestX> requests) {
        this.requests = new ArrayList<GraphRequestX>(requests);
    }
     ...
     * @param requests the requests to add to the batch
     */
    public GraphRequestBatchX(GraphRequestX... requests) {
     ...
     * @param requests the requests to add to the batch
     */
    public GraphRequestBatchX(GraphRequestBatchX requests) {
        this.requests = new ArrayList<GraphRequestX>(requests);
    ...
    @Override
    public final boolean add(GraphRequestX request) {
        return requests.add(request);
    }

    @Override
    public final void add(int location, GraphRequestX request) {
    ...
    @Override
    public final GraphRequestX get(int i) {
        return requests.get(i);
    }

    @Override
    public final GraphRequestX remove(int location) {
        return requests.remove(location);
    }

    @Override
    public final GraphRequestX set(int location, GraphRequestX request) {
    ...
    final List<GraphRequestX> getRequests() {
        return requests;
    }
     ...
     *                                  null
     */
    public final List<GraphResponseX> executeAndWait() {
    ...
    public interface Callback {
         ...
         */
        void onBatchCompleted(GraphRequestBatchX batch);
    }
    ...
    public interface OnProgressCallback extends Callback {
         ...
         */
        void onBatchProgress(GraphRequestBatchX batch, long current, long max);
    }

    List<GraphResponseX> executeAndWaitImpl() {
        return GraphRequestX.executeBatchAndWait(this);
    }
