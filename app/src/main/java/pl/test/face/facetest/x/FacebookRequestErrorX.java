 ...
 */
public final class FacebookRequestErrorX {
    ...
    private FacebookRequestErrorX(
        ...
        if (exception != null) {
            ...
            this.exception = new FacebookServiceExceptionX(this, errorMessage);
        }

        FacebookRequestErrorClassificationX errorClassification = getErrorClassification();
    ...
    FacebookRequestErrorX(HttpURLConnection connection, Exception exception) {
        this(
    ...
    public FacebookRequestErrorX(int errorCode, String errorType, String errorMessage) {
        this(
                INVALID_HTTP_STATUS_CODE,
                errorCode,
                INVALID_ERROR_CODE,
     ...
     */
    public FacebookRequestErrorX.CategoryX getCategory() {
        return category;
    }
    ...
    static FacebookRequestErrorX checkResponseAndCreateError(
        ...
        try {
            if (singleResult.has(CODE_KEY)) {
                ...
                if (body != null && body instanceof JSONObject) {
                    ...
                    if (hasError) {
                        return new FacebookRequestErrorX(
                                responseCode,
                                errorCode,
                                errorSubCode,
                                errorType,
    ...
    static synchronized FacebookRequestErrorClassificationX getErrorClassification() {
        FacebookRequestErrorClassificationX errorClassification;
        UtilityX.FetchedAppSettings appSettings =
                UtilityX.getAppSettingsWithoutQuery(FacebookSdkX.getApplicationId());
        if (appSettings == null) {
            return FacebookRequestErrorClassificationX.getDefaultErrorClassification();
        }
