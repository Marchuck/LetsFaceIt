 ...
 */
public final class AccessTokenX implements Parcelable {
    ...
    private static final AccessTokenSourceX DEFAULT_ACCESS_TOKEN_SOURCE =
            AccessTokenSourceX.FACEBOOK_APPLICATION_WEB;
    ...
    private final AccessTokenSourceX source;
     ...
     *                            cases, this will be either AccessTokenSourceX.FACEBOOK_APPLICATION
     *                            or AccessTokenSourceX.WEB_VIEW); if null, FACEBOOK_APPLICATION is
     *                            assumed.
    ...
    public AccessTokenX(
            ...
            @Nullable
            final AccessTokenSourceX accessTokenSource,
            @Nullable
     ...
     */
    public static AccessTokenX getCurrentAccessToken() {
        return AccessTokenManagerX.getInstance().getCurrentAccessToken();
    }
     ...
     */
    public static void setCurrentAccessToken(AccessTokenX accessToken) {
        AccessTokenManagerX.getInstance().setCurrentAccessToken(accessToken);
    }
    ...
    public static void refreshCurrentAccessTokenAsync() {
        AccessTokenManagerX.getInstance().refreshCurrentAccessToken();
    }
     ...
     */
    public AccessTokenSourceX getSource() {
        return source;
    }
    ...
    public interface AccessTokenCreationCallback {
         ...
         */
        public void onSuccess(AccessTokenX token);
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AccessTokenX)) {
            return false;
        }

        AccessTokenX o = (AccessTokenX) other;
    ...
    static AccessTokenX createFromRefresh(AccessTokenX current, Bundle bundle) {
        ...
        if (current.source !=     AccessTokenSourceX.FACEBOOK_APPLICATION_WEB &&
                current.source != AccessTokenSourceX.FACEBOOK_APPLICATION_NATIVE &&
                current.source != AccessTokenSourceX.FACEBOOK_APPLICATION_SERVICE) {
    ...
    static AccessTokenX createFromLegacyCache(Bundle bundle) {
        List<String> permissions = getPermissionsFromBundle(
                bundle,
                LegacyTokenHelperX.PERMISSIONS_KEY);
        List<String> declinedPermissions = getPermissionsFromBundle(
                bundle,
                LegacyTokenHelperX.DECLINED_PERMISSIONS_KEY);

        String applicationId = LegacyTokenHelperX.getApplicationId(bundle);
        if (Utility.isNullOrEmpty(applicationId)) {
            applicationId = com.facebook.FacebookSdk.getApplicationId();
        }

        String tokenString = LegacyTokenHelperX.getToken(bundle);
        String userId;
        ...
        return new AccessTokenX(
                ...
                permissions,
                declinedPermissions,
                LegacyTokenHelperX.getSource(bundle),
                LegacyTokenHelperX.getDate(
                        bundle,
                        LegacyTokenHelperX.EXPIRATION_DATE_KEY),
                LegacyTokenHelperX.getDate(
                        bundle,
                        LegacyTokenHelperX.LAST_REFRESH_DATE_KEY)
        );
    }
    ...
    static AccessTokenX createFromJSONObject(JSONObject jsonObject) throws JSONException {
      ...
      AccessTokenSourceX source = AccessTokenSourceX.valueOf(jsonObject.getString(SOURCE_KEY));
    ...
    private static AccessTokenX createFromBundle(
            List<String> requestedPermissions,
            Bundle bundle,
         AccessTokenSourceX source,
            Date expirationBase,
    ...
    private String tokenToString() {
        if (this.token == null) {
            return "null";
        } else if (com.facebook.FacebookSdk.isLoggingBehaviorEnabled(LoggingBehavior.INCLUDE_ACCESS_TOKENS)) {
            return this.token;
        } else {
    ...
    AccessTokenX(Parcel parcel) {
        ...
        this.source = AccessTokenSourceX.valueOf(parcel.readString());
    ...
    public static final Parcelable.Creator<AccessTokenX> CREATOR = new Parcelable.Creator() {

        @Override
        public AccessTokenX createFromParcel(Parcel source) {
            return new AccessTokenX(source);
        }

        @Override
        public AccessTokenX[] newArray(int size) {
            return new AccessTokenX[size];
        }
    };
}
