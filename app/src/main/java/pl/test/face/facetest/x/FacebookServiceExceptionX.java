 ...
 */
public class FacebookServiceExceptionX extends FacebookException {
    ...
    /**
     * Constructs a new FacebookServiceExceptionX.
     *
     * @param error the error from the request
     */
    public FacebookServiceExceptionX( FacebookRequestErrorX error, String errorMessage) {
        super(errorMessage);
        this.error = error;
    }
     ...
     */
    public final FacebookRequestErrorX getRequestError() {
        return error;
    }
    ...
    public final String toString() {
        return new StringBuilder()
                .append("{FacebookServiceExceptionX: ")
